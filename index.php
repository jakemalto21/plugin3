...
*/
function birth_shortcodes_init()
{
    function birth_shortcode($atts = [], $content = null)
    {
        $content .= "<script>var oBirths= " . file_get_contents("http://rhildred.github.io/births/Manufacturing2015.json") . "</script>";
        $content .= <<<EOT
...
EOT;
    ...
    add_shortcode('manufacturing-sales-plugin', 'birth_shortcode');
}
add_action('init', 'birth_shortcodes_init');
